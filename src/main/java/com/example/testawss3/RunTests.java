...
public class RunTests {
    public static void main(String[] args) {
        S3Config awsConfig = new S3Config("s3.ap-northeast-1.amazonaws.com", "ap-northeast-1",
        ...
        S3Config aliyunConfig = new S3Config("oss-cn-beijing.aliyuncs.com", "cn-beijing",
        ...
        S3Config tencentConfig = new S3Config("cos.ap-beijing.myqcloud.com", "ap-beijing",
